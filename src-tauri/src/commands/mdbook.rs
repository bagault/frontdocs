...
/// Creates src/, book/ (output), assets/, README.md for GitHub Pages hosting.
#[tauri::command]
...
- **book/** — Built HTML output (generated by mdBook)
...
The `book/` folder is ready to deploy to GitHub Pages. Configure your repository settings to serve from the `book/` directory.
"#
    );
...
async fn build_mdbook_project(
    ...
    for line in original_toml.lines() {
        if line.contains("[build]") {
            ...
            found_build = true;
        } else if found_build && line.starts_with("[") {
            // End of [build] section
            toml_lines.push(line.to_string());
            found_build = false;
        } else if !found_build || !line.contains("build-dir") {
            toml_lines.push(line.to_string());
        }
    }
